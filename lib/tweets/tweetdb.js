...
var tweetdb = [
  new Tweet('test',   '@argo15 This is a tweet.', new Date()),
  new Tweet('test',   'Cruel Owner Chains Bike Outside In Freezing Weather http://onion.com/XYjzYY', new Date()),
  new Tweet('test',   'This is a test of your emergency @sjobs tweetcast system.', new Date()),
  new Tweet('argo15', 'I\'m bill @test', new Date()),
  new Tweet('argo15', 'Tweeting @sjobs is fun', new Date()),
  new Tweet('sjobs',  'I\'m not dead @argo15 ', new Date()),
  new Tweet('sjobs',  '@test Boo', new Date())
];
